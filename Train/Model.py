...
class AfricanSlowfast(pl.LightningModule):
    ...
    def __init__(self, config):
        ...
        self.text_embedding_trainable = config['text_embedding_trainable']
        ...
        if self.enable_image_clip:
            ...
            self.transformer_ic_cl = TemporalTransformer(
                self.num_frames,
            ...
            output_width = int(config['transformer_width_ic'])
            self.mlp_oh = nn.Sequential(
    ...
    def set_text_feats(self, text_feats):
        if self.text_embedding_trainable:
