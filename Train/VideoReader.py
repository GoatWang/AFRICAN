...
if __name__ == "__main__":
    ...
    # video_fp = os.path.join(_config['data_dir'], "dataset/video/AROHKKEW.mp4")
    ...
    frames, frame_idxs, vlen = read_frames_decord(video_fp, num_frames=_config['num_frames'], fix_start=True)
