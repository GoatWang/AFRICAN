...
if __name__ == "__main__":
    ...
    video_fps = [
        os.path.join(data_dir, "dataset/video/AABCQPTK.mp4"),
        os.path.join(data_dir, "dataset/video/AADMQVEI.mp4"),
        os.path.join(data_dir, "dataset/video/AAGIUVEI.mp4"),
        os.path.join(data_dir, "dataset/video/AAIHFPKK.mp4"),
        os.path.join(data_dir, "dataset/video/AAITVVEI.mp4"),
        os.path.join(data_dir, "dataset/video/AAUQSVYU.mp4"),
        os.path.join(data_dir, "dataset/video/AAWXPNQN.mp4"),
        os.path.join(data_dir, "dataset/video/AAXNMDCC.mp4"),
        os.path.join(data_dir, "dataset/video/AAXVMCGB.mp4"),
        os.path.join(data_dir, "dataset/video/AAZYRVEI.mp4")
    ]
    ...
    frames_trans = video_aug(frames, transforms, byte=False)[0]
